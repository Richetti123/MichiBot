...
const smsSetstock = () => { return '*𝙎𝙀 𝙃𝘼 𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊 𝘾𝙊𝙍𝙍𝙀𝘾𝙏𝘼𝙈𝙀𝙉𝙏𝙀 𝙀𝙇 𝙎𝙏𝙊𝘾𝙆 𝘿𝙀 𝙏𝙐𝙎 𝙑𝙀𝙉𝙏𝘼𝙎*'}
const smsSetpagos = () => { return '*𝙎𝙀 𝙃𝘼 𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊 𝘾𝙊𝙍𝙍𝙀𝘾𝙏𝘼𝙈𝙀𝙉𝙏𝙀 𝙏𝙐𝙎 𝙈𝙀𝙏𝙊𝘿𝙊𝙎 𝘿𝙀 𝙋𝘼𝙂𝙊*'}
const smsSetreglas = () => { return '*𝙎𝙀 𝙃𝘼 𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊 𝘾𝙊𝙍𝙍𝙀𝘾𝙏𝘼𝙈𝙀𝙉𝙏𝙀 𝙏𝙐𝙎 𝙍𝙀𝙂𝙇𝘼𝙎*'}
